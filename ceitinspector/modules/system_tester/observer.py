...
from ceitinspector import approot
...
class CrashObserver( Thread ):
    ...
    def __init__(self):
        ...
        subprocess.Popen( "bash " + config.config.root_path + "/../../ceitinspector/modules/system_tester/shell/coredumpSetting.sh", shell=True )
